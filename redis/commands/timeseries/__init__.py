...
class TimeSeries(TimeSeriesCommands):
    ...
    def __init__(self, client=None, **kwargs):
        ...
        self.MODULE_CALLBACKS = {
            CREATE_CMD: redis2.client.bool_ok,
            ALTER_CMD: redis2.client.bool_ok,
            CREATERULE_CMD: redis2.client.bool_ok,
            DEL_CMD: int,
            DELETERULE_CMD: redis2.client.bool_ok,
    ...
    def pipeline(self, transaction=True, shard_hint=None):
        ...
        """
        if isinstance(self.client, redis2.RedisCluster):
            p = ClusterPipeline(
...
class ClusterPipeline(TimeSeriesCommands, redis2.cluster.ClusterPipeline):
    """Cluster pipeline for the module."""


class Pipeline(TimeSeriesCommands, redis2.client.Pipeline):
